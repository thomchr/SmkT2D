...
smk_int_harm <- harmonise_data(exposure_dat = smk_int_clumped, outcome_dat = cad_data)
bmi_harm <- harmonise_data(exposure_dat = bmi_sub, outcome_dat = cad_data)
