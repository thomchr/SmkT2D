...
mvmr.t2d <- read.csv("/Users/dr/Desktop/MR.SMK-T2D/non_overlap_analyses/instruments/instrument.LtSmk_bmi->t2d.csv", 
...
# snp -> risk factor
betaXG <- mvmr.t2d$liftime.smoking.effect.size
sebetaXG <- mvmr.t2d$liftime.smoking.standard.error
