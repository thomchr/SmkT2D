...
colnames(int) <- c("rsid", "chromosome", "position", "effect allele", "non-effect allele",
                   ...
                   "Lifetime-smoking standard error", "T2D effect size", "T2D standard error")

write.csv(int, "/Users/dr/Desktop/MR.SMK-T2D/non_overlap_analyses/instruments/instrument.LtSmk->t2d.csv", row.names = FALSE)
...
p1
pdf("/Users/dr/Desktop/MR.SMK-T2D/non_overlap_analyses/scatterplots/LtSmk->t2d.scatter.pdf")
p1[[1]]
dev.off()
