...
colnames(merge.sig) <- c("key","chr.exposure","pos.exposure","SNP","other_allele.exposure",
                         "effect_allele.exposure","eaf.exposure","pval.exposure","beta.exposure","se.exposure",
                         "samplesize.exposure","exposure","mr_keep.exposure","pval_origin.exposure","id.exposure",
                         "SNP.y","effect_allele.exposure.y","other_allele.exposure.y","eaf.exposure.y",
                         "beta.exposure.y","se.exposure.y","pval.exposure.y","samplesize.exposure.y",
                         "chr.exposure.y","pos.exposure.y","exposure.y","mr_keep.exposure.y","pval_origin.exposure.y",
                         "id.exposure.y")
...
clumped$samplesize.exposure.y <- 339224
# smk->bmi
