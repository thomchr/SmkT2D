...
write.csv(int, "/Users/dr/Desktop/MR.SMK-T2D/non_overlap_analyses/instruments/instrument.LtSmk->bmi.csv", row.names = FALSE)
...
p1
pdf("/Users/dr/Desktop/MR.SMK-T2D/non_overlap_analyses/scatterplots/LtSmk->bmi.scatter.pdf")
p1[[1]]
dev.off()
