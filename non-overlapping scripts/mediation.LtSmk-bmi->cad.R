...
mvmr.cad <- read.csv("/Users/dr/Desktop/MR.SMK-T2D/non_overlap_analyses/instruments/instrument.LtSmk_bmi->cad.csv", 
...
# snp -> risk factor
betaXG <- mvmr.cad$liftime.smoking.effect.size
sebetaXG <- mvmr.cad$liftime.smoking.standard.error
