...
colnames(int) <- c("rsid", "chromosome", "position", "effect allele", "non-effect allele",
                             ...
                             "smoking-initiation standard error", "CAD effect size", "CAD standard error")

write.csv(int, "/Users/dr/Desktop/MR.SMK-T2D/non_overlap_analyses/instruments/instrument.SmkInt->cad.csv", row.names = FALSE)
...
p1
pdf("/Users/dr/Desktop/MR.SMK-T2D/non_overlap_analyses/scatterplots/smk->cad.scatter.pdf")
p1[[1]]
dev.off()
