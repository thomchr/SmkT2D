...
colnames(merge.sig) <- c("key","SNP","chr.exposure","pos.exposure","effect_allele.exposure",
                         ...
                         "eaf.exposure.y","beta.exposure.y","se.exposure.y","pval.exposure.y",
                         "samplesize.exposure.y","chr.exposure.y","pos.exposure.y","exposure.y",
