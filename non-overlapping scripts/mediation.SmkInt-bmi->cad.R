...
mvmr.cad <- read.csv("/Users/dr/Desktop/MR.SMK-T2D/non_overlap_analyses/instruments/instrument.SmkInt_bmi->cad.csv", 
...
# snp -> risk factor
betaXG <- mvmr.cad$smoking.initiation.effect.size
sebetaXG <- mvmr.cad$smoking.initiation.standard.error
...
#write.csv(result.cad, "/Users/dr/Desktop/MR.SMK-cad/non_overlap_analyses/nonoverlap.combined_IV.mediation.cad.csv")  
