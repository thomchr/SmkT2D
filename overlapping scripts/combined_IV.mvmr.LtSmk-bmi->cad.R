...
colnames(merge.sig) <- c("key","SNP","effect_allele.exposure","other_allele.exposure",
                         ...
                         "ambiguous","id.outcome","se.outcome","chr.outcome","pos.outcome",
                         "outcome","mr_keep.outcome","pval.outcome","pval_origin.outcome","chr.exposure",
                         ...
                         "se.outcome.y","chr.outcome.y","pos.outcome.y","outcome.y","mr_keep.outcome.y",
                         "pval.outcome.y","pval_origin.outcome.y","chr.exposure.y","pos.exposure.y",
                         "se.exposure.y","pval.exposure.y","samplesize.exposure","exposure.y",
...
write.csv(int, "/Users/dr/Desktop/MR.SMK-T2D/better_instrumnet_mvmr/instruments/combined_IV.LtSmk_bmi->cad.instrument.csv", row.names = FALSE)
