mvmr.t2d <- read.csv("/Users/dr/Desktop/MR.SMK-T2D/better_instrumnet_mvmr/instruments/combined_IV.LtSmk_bmi->t2d.instrument.csv", 
...
# snp -> risk factor
betaXG <- mvmr.t2d$lifetime.smoking.effect.size
sebetaXG <- mvmr.t2d$lifetime.smoking.standard.error
...
write.csv(result.t2d, "/Users/dr/Desktop/MR.SMK-T2D/better_instrumnet_mvmr/combined_IV.direct_total.t2d.csv")  
