...
colnames(merge.sig) <- c("key","SNP","effect_allele.exposure","other_allele.exposure",
                         ...
                         "se.outcome","chr.outcome","pos.outcome","outcome","mr_keep.outcome","pval.outcome",
                         "pval_origin.outcome","chr.exposure","pos.exposure","pval.exposure","se.exposure",
                         "samplesize.exposure","exposure","mr_keep.exposure","pval_origin.exposure",
                         "id.exposure","action","mr_keep","samplesize.outcome",
                         ...
                         "eaf.outcome.y","remove.y","palindromic.y","ambiguous.y","id.outcome.y","se.outcome.y",
                         "chr.outcome.y","pos.outcome.y","outcome.y","mr_keep.outcome.y","pval.outcome.y",
                         "pval_origin.outcome.y","chr.exposure.y","pos.exposure.y","se.exposure.y","pval.exposure.y",
                         "samplesize.exposure.y","exposure.y","mr_keep.exposure.y","pval_origin.exposure.y",
...
write.csv(int, "/Users/dr/Desktop/MR.SMK-T2D/better_instrumnet_mvmr/instruments/combined_IV.SmkInt_bmi->cad.instrument.csv", row.names = FALSE)
