...
# forestplot
setwd("/Users/dr/Desktop/MR.SMK-T2D/better_instrument_forestplots")
pdf("mr.smk->HbA1c.pdf")
res_single <- mr_singlesnp(smk_harm, all_method = c("mr_ivw",
                                               "mr_egger_regression",
                                               "mr_weighted_median"))
...
# # scatter plot
# pdf("scatter/mr.smk->HbA1c.scatter.pdf")
# mr_scatter_plot(smk_bmi_res, smk_harm)
# dev.off()
