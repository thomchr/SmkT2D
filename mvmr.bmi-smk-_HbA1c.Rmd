...
smk_int_harm <- harmonise_data(exposure_dat = smk_int, outcome_dat = hb_data)
bmi_harm <- harmonise_data(exposure_dat = bmi_sub_clumped, outcome_dat = hb_data)
