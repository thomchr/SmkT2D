...
smk_int_harm <- harmonise_data(exposure_dat = smk_int_clumped, outcome_dat = pad_data)
bmi_harm <- harmonise_data(exposure_dat = bmi_sub, outcome_dat = pad_data)
...
colnames(smk_int_harm)[c(6, 20)] <- c("beta.smk", "se.smk")
colnames(bmi_harm)[c(6, 19)] <- c("beta.bmi", "se.bmi")

colnames(smk_int_harm)[c(7, 14)] <- c("beta.outcome.smk", "se.outcome.smk")
colnames(bmi_harm)[c(7, 14)] <- c("beta.outcome.bmi", "se.outcome.bmi")
...
final_instrument <- data.frame("beta.smk" = c(combined$beta.smk, combined.px$beta.smk),
                               ...
                               "beta.t2d" = c(combined$beta.outcome.smk, combined.px$beta.outcome.smk),
                               "se.t2d" = c(combined$se.outcome.smk, combined.px$se.outcome.smk),
